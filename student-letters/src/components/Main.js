...
let letters = [
...

  {
    ...
    Location: "FLA",
    Letter:
      "I believe that if you want to succeed in this course you must follow some rules. No matter how difficult it is, DO NOT compare yourself to others. Do not be shy and ask as many questions as you can. It's okay not to understand a concept right away, just keep practicing because it will click eventually. Lastly, DO NOT give up for hard work will never fail you. The light at the end of the tunnel is much closer than you think",
  },
      ...
      <div className="Main">
        <div className="Main-text">
          ...
          <div className="middle">
            <button id="next-letter" className="button" onClick={raiseNum}>
              Next Letter
            </button>
          </div>
        </div>
